...
Publish the package config file and migrations to your application. Run these commands inside your terminal.
    ...
    php artisan vendor:publish --provider="Laravelit\Roles\RolesServiceProvider" --tag=config
    php artisan vendor:publish --provider="Laravelit\Roles\RolesServiceProvider" --tag=migrations
...
```php
use Laravelit\Roles\Traits\HasRoleAndPermission;
use Laravelit\Roles\Contracts\HasRoleAndPermission as HasRoleAndPermissionContract;
...
```php
use Laravelit\Roles\Models\Role;
...
```php
use Laravelit\Roles\Models\Permission;
...
protected $routeMiddleware = [
    ...
    'role' => \Laravelit\Roles\Middleware\VerifyRole::class,
    'permission' => \Laravelit\Roles\Middleware\VerifyPermission::class,
    'level' => \Laravelit\Roles\Middleware\VerifyLevel::class,
];
```
...
It throws `\Laravelit\Roles\Exceptions\RoleDeniedException`, `\Laravelit\Roles\Exceptions\PermissionDeniedException` or `\Laravelit\Roles\Exceptions\LevelDeniedException` exceptions if it goes wrong.
...
{
    if ($e instanceof \Laravelit\Roles\Exceptions\RoleDeniedException) {
...
For more information, please have a look at [HasRoleAndPermission](https://github.com/romanbican/roles/blob/master/src/Laravelit/Roles/Contracts/HasRoleAndPermission.php) contract.
